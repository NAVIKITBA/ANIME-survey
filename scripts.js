...
function calculateMBTIPersonality() {
    ...
    const personalityDescriptions = {
        "ESTJ": "ESTJ - The Executive: Logical, organized, and assertive. They like to manage and make decisions.",
        "ESFJ": "ESFJ - The Consul: Warm, empathetic, and cooperative. They value harmony and relationships.",
        "ENTJ": "ENTJ - The Commander: Decisive, strategic, and leadership-driven. They enjoy planning and taking charge.",
        "ENFJ": "ENFJ - The Protagonist: Charismatic, inspiring, and empathetic. They seek to help others grow.",
        "ISTJ": "ISTJ - The Logistician: Practical, responsible, and detail-oriented. They prefer structure and reliability.",
        "ISFJ": "ISFJ - The Defender: Caring, supportive, and loyal. They prioritize helping others and maintaining stability.",
        "INTJ": "INTJ - The Architect: Innovative, independent, and strategic. They focus on long-term goals and improvements.",
        "INFJ": "INFJ - The Advocate: Insightful, compassionate, and principled. They are driven by a deep sense of purpose.",
        "ESTP": "ESTP - The Entrepreneur: Energetic, bold, and action-oriented. They enjoy new experiences and challenges.",
        "ESFP": "ESFP - The Entertainer: Fun-loving, spontaneous, and social. They seek excitement and enjoy living in the moment.",
        "ENTP": "ENTP - The Debater: Inventive, curious, and quick-witted. They enjoy engaging in challenging intellectual discussions.",
        "ENFP": "ENFP - The Campaigner: Enthusiastic, creative, and idealistic. They value individuality and authenticity.",
        "ISTP": "ISTP - The Virtuoso: Adventurous, practical, and skilled. They like to solve problems with hands-on approaches.",
        "ISFP": "ISFP - The Adventurer: Artistic, sensitive, and independent. They value personal expression and aesthetic beauty.",
        "INTP": "INTP - The Thinker: Analytical, curious, and theoretical. They enjoy solving complex problems and exploring new ideas.",
        "INFP": "INFP - The Mediator: Empathetic, idealistic, and introspective. They seek deep meaning and personal growth."
    };
